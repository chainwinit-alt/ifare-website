...
(function () {
    ...
    function loginUserInternal(tenantId, callback) {
        ...
        const req_path = window.location.pathname.indexOf("/ifare_bdapi") >= 0 ? '/ifare_bdapi/api/TokenAuth/Authenticate' : '/api/TokenAuth/Authenticate'

        xhr.open('POST', req_path, true);
