...
namespace IFare_BDAPI.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = IFare_BDAPIConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(IFare_BDAPIDbContext context)
        {
            _context = context;
        }
