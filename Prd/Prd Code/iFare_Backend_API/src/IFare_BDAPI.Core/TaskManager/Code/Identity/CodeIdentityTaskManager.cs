...
{
    public class CodeIdentityTaskManager : ICodeIdentityTaskManager
    {
        private readonly IRepository<CodeIdentity> _repositoryCodeIdentity;
        private readonly ICommonToolsManager _commonTools;
        public CodeIdentityTaskManager(IRepository<CodeIdentity> repositoryCodeIdentity, ICommonToolsManager commonTools)
        {
        ...
        public CodeResult GetDataList(CodeFilterParam param)
        {
            ...
            var query = _repositoryCodeIdentity.GetAll();
        ...
        public ErrorInfoBase InsertCodeIdentity(CodeInsertData insertData)
        {
            try 
            {
                ...
                _repositoryCodeIdentity.Insert(new CodeIdentity 
                {
        ...
        public ErrorInfoBase UpdateCodeIdentity(CodeEditorData editorData)
        {
            try 
            {
                ...
                var item = _repositoryCodeIdentity.GetAll()
                ...
                _repositoryCodeIdentity.Update(item);
