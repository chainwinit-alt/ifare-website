...
{
    public class CodeIncomeTaskManager : ICodeIncomeTaskManager
    {
        private readonly IRepository<CodeIncome> _repositoryCodeIncome;
        private readonly ICommonToolsManager _commonTools;
        public CodeIncomeTaskManager(IRepository<CodeIncome> repositoryCodeIncome, ICommonToolsManager commonTools)
        {
        ...
        public CodeResult GetDataList(CodeFilterParam param)
        {
            ...
            var query = _repositoryCodeIncome.GetAll();
        ...
        public ErrorInfoBase InsertCodeIncome(CodeInsertData insertData)
        {
            try 
            {
                ...
                _repositoryCodeIncome.Insert(new CodeIncome 
                {
        ...
        public ErrorInfoBase UpdateCodeIncome(CodeEditorData editorData)
        {
            try 
            {
                ...
                var item = _repositoryCodeIncome.GetAll()
                ...
                _repositoryCodeIncome.Update(item);
