...
{
    /// <summary>
    /// 福利文章應用服務（Application Service）。
    /// 提供福利類文章的查詢、新增、修改及刪除功能，所有操作皆需 JWT 驗證。
    /// 對應後台管理系統中「福利文章管理」功能模組。
    /// </summary>
    ...
    public class ArticlesWelfareAppService : AbpServiceBase, IArticlesWelfareAppService
    {
        ...
        /// 建構子，透過相依性注入初始化依賴項目。
        /// </summary>
        /// <param name="articlesWelfareTaskManager">福利文章任務管理器</param>
