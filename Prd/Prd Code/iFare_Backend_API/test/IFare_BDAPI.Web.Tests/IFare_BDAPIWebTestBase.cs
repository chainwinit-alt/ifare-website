...
{
    public abstract class IFare_BDAPIWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static IFare_BDAPIWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(IFare_BDAPIWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<IFare_BDAPIDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<IFare_BDAPIDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<IFare_BDAPIDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<IFare_BDAPIDbContext, Task<T>> func)
        {
            T result;
