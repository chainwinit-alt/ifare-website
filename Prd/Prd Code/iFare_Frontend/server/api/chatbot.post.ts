...
const KNOWLEDGE_BASE: KnowledgeEntry[] = [
  ...
  {
    title: '聯絡資訊',
    keywords: ['聯絡', '客服', '電話', 'email', 'facebook'],
    answer:
      '基金會聯絡方式如下：電話 02-2797-8383、Email ifaretw@gmail.com，也可以前往 i-Fare Facebook 粉絲團。',
  },
  {
    title: '如何使用小幫手',
    keywords: ['怎麼用', '使用方式', '如何使用', '小幫手'],
    answer:
      '你可以直接提問福利政策、聯絡資訊、公益夥伴、捐款與最新消息，芒寶會依照目前的站內資料協助整理。',
  },
  {
    title: '服務邊界',
    keywords: ['個案', '判斷', '專業', '法律', '醫療'],
    answer:
      '小幫手只能做站內導覽與一般資訊整理，不能代替申請資格、法律或醫療判斷；可先查看相關政策的適用對象與申請說明。',
  },
];
...
const API_UNAVAILABLE_FALLBACK_REPLY =
  '你可以先查看 i-Fare、公益夥伴、最新消息或福利專欄，芒寶會依照目前的站內資料協助整理。';
...
const HYBRID_SYSTEM_PROMPT = [
  ...
  '回答時優先使用下列固定知識庫；若知識庫無法支撐結論，就明確說明你不確定，並引導使用者到對應的站內頁面。',
