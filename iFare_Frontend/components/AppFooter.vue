      ...
      <div class="part part-info">
        ...
        <ul class="list-unstyled footer-info-items">
            <li name="tel">
                ...
                <span>(02)2797-8383</span>
            </li>
            <li name="mail">
                <span class="footer-info-label"><i class="footer-info-icon ic-info-mail"></i>聯絡信箱</span>
                <span>ifaretw@gmail.com</span>
            </li>
            <li name="address">
                <span class="footer-info-label"><i class="footer-info-icon ic-info-address"></i>地址</span>
                <span>台北市內湖區瑞光路616號13樓</span>
            </li>
            <li name="datetime">
                <span class="footer-info-label"><i class="footer-info-icon ic-info-time"></i>服務時間</span>
