...
{
    public abstract class IFare_APIWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static IFare_APIWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(IFare_APIWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<IFare_APIDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<IFare_APIDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<IFare_APIDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<IFare_APIDbContext, Task<T>> func)
        {
            T result;
