...
namespace IFare_BDAPI.Constants
{
    public static class ErrAPI
    {
        ...
        public const int ErrorInfoCode_PermissionFail = -3;
        public const float Code_PermissionFail = -3F;
        public const string Msg_PermissionFail = "權限不足/Permission Fail";
        ...
        public static readonly Dictionary<float, ErrorInfoBase> RefDict = new Dictionary<float, ErrorInfoBase>
        {
            ...
            { Code_PermissionFail, new ErrorInfoBase(ErrorInfoCode_PermissionFail, Msg_PermissionFail) },
