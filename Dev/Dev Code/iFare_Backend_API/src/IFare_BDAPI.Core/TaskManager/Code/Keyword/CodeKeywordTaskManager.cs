...
{
    public class CodeKeywordTaskManager : ICodeKeywordTaskManager
    {
        private readonly IRepository<CodeKeyword> _repositoryCodeKeyword;
        private readonly ICommonToolsManager _commonTools;
        public CodeKeywordTaskManager(IRepository<CodeKeyword> repositoryCodeKeyword, ICommonToolsManager commonTools)
        {
        ...
        public CodeResult GetDataList(CodeFilterParam param)
        {
            ...
            var query = _repositoryCodeKeyword.GetAll();
        ...
        public ErrorInfoBase InsertCodeKeyword(CodeInsertData insertData)
        {
            try 
            {
                ...
                _repositoryCodeKeyword.Insert(new CodeKeyword 
                {
        ...
        public ErrorInfoBase UpdateCodeKeyword(CodeEditorData editorData)
        {
            try 
            {
                ...
                var item = _repositoryCodeKeyword.GetAll()
                ...
                _repositoryCodeKeyword.Update(item);
