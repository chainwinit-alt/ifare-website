...
namespace IFare_BDAPI.TaskManager.News.Common
{
    ...
    {
        private NewsInsertData _insertData;
        private NewsEditorData _editorData;
        private readonly InputDataChecker _inputDataChecker;
        private string _errMsg = "NA";
        public InputChecker(NewsInsertData insertData)
        {
            _insertData = insertData;
            _inputDataChecker = new InputDataChecker();
        }

        public InputChecker(NewsEditorData editorData)
        {
