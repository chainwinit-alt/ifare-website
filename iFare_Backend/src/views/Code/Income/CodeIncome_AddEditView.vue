<template>
  <main-header>
    <template #subtitle v-if="$route.name != 'Code_Income_Add'">
  ...
  <el-scrollbar class="main-scrollbar">
    <div
      class="section-main-card card-fullsize card-code-income card-input-format"
    >
      <div class="card-info">
  ...
  if (routeNameType.indexOf("add") >= 0) {
    ...
    $WebAPI.InsertCodeIncome(
      ...
      (res: any) => {
        ...
        $commonLib.GuideToPage("Code_Income_DataList");
      }
    );
  }
