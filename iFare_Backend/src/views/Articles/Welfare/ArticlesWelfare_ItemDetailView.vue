<template>
  <main-header>
    ...
    <template #subtitle v-if="$route.name != 'Articles_Welfare_Add'">
...
const handleClick = () => {
  _global?.$router.push({ name: "Articles_Welfare_Edit", query: { id: _$route?.query.id } });
};
